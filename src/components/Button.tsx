    ...
    <div className="flex items-center justify-center">
      <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-current" fill="none" viewBox="0 0 24 24">
        ...
        <path
          ...
          fill="currentColor"
          d="M4 12a8 8 0 018-8V0C5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"
        />
      </svg>
      {children}
    </div>
  ...
  return (
    <button
      ...
      className={`cursor-pointer px-5 py-2.5 rounded-xl font-medium transition-all flex items-center justify-center
        ...
        ${isLoading || disable ? "opacity-70 cursor-not-allowed" : ""}
        ${fullWidth ? "w-full" : ""}
        `}
