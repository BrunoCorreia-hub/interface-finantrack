					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
						<div>
							<h1 className="text-4xl md:text-5xl font-bold text-white mb-5">
								...
								<span className="text-5xl md:text-6xl text-primary-500">
									DevBills
								</span>
							</h1>
						...
						<div className="text-center">
							...
							<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
								{features.map((feature) => (
									<div
										key={feature.title}
										className="bg-gray-900 p-6 rounded-xl hover:shadow-lg"
									>
										<div className="bg-gray-950 rounded-full inline-block p-3 mb-4">
											{feature.icon}
										</div>
										<h3 className="text-white p-4 text-2xl font-bold">
											{feature.title}
										</h3>
